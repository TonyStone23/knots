...
B = [
    [b0, b1, b2, b3, b4, b5],
    [b1, quantum2 * b1, b3, quantum2 * b3, b1 + b5, quantum2 * b5],
    [b2, b4, quantum2 * b2, b2 + b5, quantum2 * b4, quantum2 * b5],
    [b3, b1 + b5, quantum2 * b3, quantum2 * b5 + b3, quantum2 * (b1 + b5), quantum2**2 * b5],
    [b4, quantum2 * b4, b2 + b5, quantum2 * (b2 + b5), quantum2 * b5 + b4, quantum2**2 * b5],
